...
#loading model
model_cancer = pickle.load(open('Multiple_Disease_prediction_system/breast_cancer/breast_cancer.pkl', 'rb'))
model_diabetes = pickle.load(open('Multiple_Disease_prediction_system/diabetes/diabetes.pkl', 'rb'))
model_heart = pickle.load(open('Multiple_Disease_prediction_system/heart_disease/heart_disease.pkl', 'rb'))
